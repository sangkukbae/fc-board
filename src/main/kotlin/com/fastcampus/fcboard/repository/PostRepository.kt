...
interface CustomPostRepository {
    fun findPageBy(pageRequest: PageRequest, postSearchRequestDto: PostSearchRequestDto): Page<Post>
}

class CustomPostRepositoryImpl : CustomPostRepository, QuerydslRepositorySupport(Post::class.java) {

    override fun findPageBy(pageRequest: PageRequest, postSearchRequestDto: PostSearchRequestDto): Page<Post> {
